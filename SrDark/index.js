		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD FOX BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo do Fox. Registre-se para fazer amizade com o bot Fox por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Fox|17\n\n──「 FOX BOT 」──`,
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO FOX BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @fox domina vida
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                ...
                case 'ninjalogo':
                    ...
                    client.sendMessage(from, tod, image, { quoted: mek, caption: '*Fox domina ✓*'})
                    break
                    case 'bruteforcefb':
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT FOX ✨* 」\n*│+ wa.me/5521979664189*╰──────*「 *FOX* 」*────*\n\n*_SE QUER SER ADMIN DO BOT FOX_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do Fox:*\n\n https://youtube.com/channel/UC6B_ThRGhMPzz4EmSjJcMaA'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
